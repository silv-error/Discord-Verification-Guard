...
from .utils.logger import send_kick_log
...
async def scan_existing_members(bot):
    ...
    for guild in bot.guilds:
        ...
        if found_in_guild > 0:
            ...
            print(f"[{guild.name}] ✅ Found {found_in_guild} unverified member(s)")
        
        bot.save_data()
    
    print(f"✅ Scan complete! Tracking {total_found} member(s) total\n")
